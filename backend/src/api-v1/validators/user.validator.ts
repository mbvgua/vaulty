...
export const registerSchema = Joi.object({
  first_name: Joi.string().required().alphanum().lowercase().trim().messages({
    ...
    "string.trim": "Firstname cannot contain any whitespace before or after it",
  }),
  last_name: Joi.string().required().alphanum().lowercase().trim().messages({
    "string.base": "Lastname must be a string",
    "any.required": "Lastname is required",
    "string.alphanum": "Lastname can only contain letters(a-z) and digits(0-9)",
    "string.lowercase": "Lastname can only be in lowercase letters",
    "string.trim": "Lastname cannot contain any whitespace before or after it",
  }),
